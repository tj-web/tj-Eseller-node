...
export const getDemosController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const getLeadHistoryController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const addRemarkReminderController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const leadStatusHandlerController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const getLeadDetailsController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
        const lead_id = req.query.lead_id;
...
export const setFollowupController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const getLeadAcdHistoryController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const acceptDemoController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const rescheduleDemoController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const scheduleCallbackController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const getVendorContactsController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const getLeadInsightsController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
        const lead_id = req.query.lead_id;
...
export const unlockContactController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
        const { lead_id } = req.query.lead_id ? req.query : req.body;
...
export const unlockLeadInsightsController = async (req, res, next) => {
    try {
        const vendor_id = req.user.vendor_id;
...
export const getLeadLocationsController = async (req, res, next) => {
    try {
